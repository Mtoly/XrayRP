...
نسخه پیش‌انتشار فعلی: `0.9.1-alpha`
...
# این پروژه فقط برای یادگیری، توسعه و نگهداری شخصی است. من هیچ‌گونه قابلیت استفاده را تضمین نمی‌کنم و مسئولیتی در قبال پیامدهای استفاده از این نرم‌افزار ندارم.
# این پروژه فقط برای یادگیری، توسعه و نگهداری شخصی است. من هیچ‌گونه قابلیت استفاده را تضمین نمی‌کنم و مسئولیتی در قبال پیامدهای استفاده از این نرم‌افزار ندارم.
# این پروژه فقط برای یادگیری، توسعه و نگهداری شخصی است. من هیچ‌گونه قابلیت استفاده را تضمین نمی‌کنم و مسئولیتی در قبال پیامدهای استفاده از این نرم‌افزار ندارم.
# این پروژه فقط برای یادگیری، توسعه و نگهداری شخصی است. من هیچ‌گونه قابلیت استفاده را تضمین نمی‌کنم و مسئولیتی در قبال پیامدهای استفاده از این نرم‌افزار ندارم.
# این پروژه فقط برای یادگیری، توسعه و نگهداری شخصی است. من هیچ‌گونه قابلیت استفاده را تضمین نمی‌کنم و مسئولیتی در قبال پیامدهای استفاده از این نرم‌افزار ندارم.

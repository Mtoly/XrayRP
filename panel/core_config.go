...
func defaultCoreConfigBuilder() coreConfigBuilder {
	return coreConfigBuilder{newInstance: core.New}
}

func (b coreConfigBuilder) Build(panelConfig *Config) (*core.Instance, error) {
	// Log Config
	...
	server, err := b.newInstance(config)
	if err != nil {

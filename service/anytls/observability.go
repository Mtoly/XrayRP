...
func (s *AnyTLSService) ObservabilitySnapshot() service.RuntimeSnapshot {
	if s == nil {
		return service.RuntimeSnapshot{Kind: service.RuntimeKindAnyTLS, Lifecycle: service.RuntimeLifecycleStopped, WebSocket: service.WebSocketDisabled}
	}
	...
	return service.RuntimeSnapshot{
		Kind:                 service.RuntimeKindAnyTLS,
		NodeID:               nodeID,
...
func (s *AnyTLSService) refreshCertificateExpiry() {
